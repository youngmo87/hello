...
class Result:
    ...
    def callclass(self, name, idnum):
        self.name=name
        self.idnum=idnum
        print("{}님 아이디는{}이 생성되었습니다.".format(self.name,self.idnum))
        self.addrcheck(self.name, self.idnum)
    
    def addrcheck(self, name, idnum):
        self.name=name
        self.idnum=idnum
        print("주소확인") 
        Address(self.name, self.idnum)
